public class Account {
    ...
    public Account(String customerName, String customerEmail, long accountNumber, int accountBalance) {
    ...
    public Account(String customerName, String customerEmail, long accountNumber) {
        this(customerName,customerEmail, accountNumber, 5000);
    }
